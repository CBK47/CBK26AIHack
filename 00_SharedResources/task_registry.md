...
| ID | Task | Priority | Owner | Status | Notes |
|---|---|---|---|---|---|
| SH-001 | Keep architecture spec synchronized with project topology | High | all | in_progress | Update on boundary/topology change |
| SH-002 | Keep handover and debrief concise and current | High | all | in_progress | Update every handoff/session |
